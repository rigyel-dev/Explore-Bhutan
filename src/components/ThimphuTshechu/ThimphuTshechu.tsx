     ...
     <Box  p="6" rounded="md" order={2} flex="1" textAlign="justify">
              ...
              <Text margin="18px">Thimphu Tshechu is the biggest and the most popular festival of Bhutan. 
                ...
                all decked up in fine colorful attires to be a part of the festivities. There are colors,
                 there are dance performances, there are activities, and there are plays in this Bhutan festival in 2025. 
                 However, the colorful mask dances, where people and monks dance their heart out to celebrate life and cheeriness of Bhutan,
                  steal the show. <br />
    
    <strong>Duration:</strong> 3 days <br />
    
    <strong>When: 10th Day</strong>  of 8th month of Lunar Calendar</Text>
            </Box>
  )
}

export default ThimphuTshechu